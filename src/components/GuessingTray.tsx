...
export const GuessingTray = () => {
  ...
  return (
    <div className="w-full bg-white dark:bg-dark-card p-4 sm:p-6 rounded-t-3xl border-t-4 border-bubbly-teal shadow-[0_-10px_40px_rgba(0,0,0,0.1)] dark:shadow-[0_-10px_40px_rgba(0,0,0,0.3)]">
      ...
      <div className="relative w-full">
              ...
              return (
                <motion.div
                  ...
                  className={`
                    ...
                    bg-white dark:bg-dark-border rounded-2xl shadow-lg border-b-8 
                    ${used 
                ...
                >
                  ...
                  <span className="text-sm font-bold text-text-dark-blue bg-soft-gray dark:bg-gray-700 dark:text-dark-text px-3 py-1 rounded-full whitespace-nowrap">
        ...
        <div className="absolute top-0 bottom-0 left-0 w-16 bg-gradient-to-r from-white dark:from-dark-card to-transparent pointer-events-none" />
        <div className="absolute top-0 bottom-0 right-0 w-16 bg-gradient-to-l from-white dark:from-dark-card to-transparent pointer-events-none" />
      </div>
    </div>
  );
};
